...
import itemSidebarDataAdmin from "../dataAdmin/itemSlideBar";
import { useRouter } from "next/router";
import Link from "next/link";
const ItemMenuLeftAdmin = ({ id, name, icon }: ISidebarData) => {
  const Icon = icon;
  ...
  return (
    <div className="mb-4">
      ...
      {itemSidebarDataAdmin.map((item, index) => {
...
export default ItemMenuLeftAdmin;
