...
const FilterPrice = () => {
  ...
  const [minPrice, setMinPrice] = useState<number | undefined>(router.query.minPrice ? +router.query.minPrice : undefined);
  const [maxPrice, setMaxPrice] = useState<number | undefined>(router.query.maxPrice ? +router.query.maxPrice : undefined);
